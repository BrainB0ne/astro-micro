...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/hibp2sqlite/releases/download/v0.2.0/hibp2sqlite-0.2.0-x64.zip">hibp2sqlite v0.2.0 (win64-zip)</DownloadLinkButton>
</div>
<Callout type="info">
...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/hibp2sqlite/releases/download/v0.2.0/hibp2sqlite-0.2.0-x86_64.AppImage">hibp2sqlite v0.2.0 (x86_64-AppImage)</DownloadLinkButton>
</div>
...
<div class="flex gap-2">
  <LinkButton
    ...
    icon="github"
    loading="lazy"
    href="https://github.com/BrainB0ne/hibp2sqlite">Available on GitHub</LinkButton>
  <LinkButton
    external
    icon="codeberg"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/hibp2sqlite">Get it on Codeberg</LinkButton>
</div>
