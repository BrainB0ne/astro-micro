...
<div class="flex flex-wrap gap-y-2">
    <DownloadLinkButton icon="download" href="https://codeberg.org/BrainB0ne/hibp2sqlite/releases/download/v0.2.0/hibp2sqlite-0.2.0-x64.zip">hibp2sqlite v0.2.0 (x64-windows-zip)</DownloadLinkButton>
</div>
<Callout type="info">
...
### Linux
<div class="flex flex-wrap gap-y-2">
    <DownloadLinkButton icon="download" href="https://codeberg.org/BrainB0ne/hibp2sqlite/releases/download/v0.2.0/hibp2sqlite-0.2.0-x86_64.AppImage">hibp2sqlite v0.2.0 (x86_64-AppImage)</DownloadLinkButton>
</div>

## 💻 Source
<div class="flex gap-2">
    <LinkButton external icon="github" href="https://github.com/BrainB0ne/hibp2sqlite">Available on GitHub</LinkButton>
    <LinkButton external icon="codeberg" href="https://codeberg.org/BrainB0ne/hibp2sqlite">Get it on Codeberg</LinkButton>
</div>
