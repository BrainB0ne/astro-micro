...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/hostednetwork-gui/releases/download/v0.3.0/whnm-0.3.0-win32-setup.exe"
  >WLAN Hosted Network Manager v0.3.0 (win32-installer)</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/hostednetwork-gui/releases/download/v0.3.0/whnm-0.3.0-win32.zip"
  >WLAN Hosted Network Manager v0.3.0 (win32-zip)</DownloadLinkButton>
</div>
...
<div class="flex gap-2">
  <LinkButton
    ...
    icon="github"
    loading="lazy"
    href="https://github.com/BrainB0ne/hostednetwork-gui"
  >Available on GitHub</LinkButton>
  <LinkButton
    external
    icon="codeberg"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/hostednetwork-gui"
