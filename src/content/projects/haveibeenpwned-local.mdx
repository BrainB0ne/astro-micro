...
<Link external href="https://medium.com/analytics-vidhya/creating-a-local-version-of-the-haveibeenpwned-password-database-with-python-and-sqlite-918a7b6a238a">Creating a local version of the Haveibeenpwned password database (with Python and SQLite)</Link>
