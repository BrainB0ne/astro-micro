...
<div class="flex flex-wrap justify-between gap-y-2">
    <DownloadButton href="https://www.brainbytez.nl/download/825/" icon="download">Qt Minecraft Server v0.1.0 (windows-installer)</DownloadButton>
    <DownloadButton href="https://www.brainbytez.nl/download/827/" icon="download">Qt Minecraft Server v0.1.0 (windows-zip)</DownloadButton>
</div>

### Linux
<div class="flex flex-wrap justify-between gap-y-2">
    <DownloadButton href="https://www.brainbytez.nl/download/831/" icon="download">Qt Minecraft Server v0.1.0 (32bit-linux-tar.gz)</DownloadButton>
    <DownloadButton href="https://www.brainbytez.nl/download/829/" icon="download">Qt Minecraft Server v0.1.0 (64bit-linux-tar.gz)</DownloadButton>
</div>
