...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.4.1/plainmd-1.4.1-x64-setup.exe">{"PlainMD v1.4.1 (win64-installer)"}</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.4.1/plainmd-1.4.1-x64-portable.zip">{"PlainMD v1.4.1 (win64-zip)"}</DownloadLinkButton>
</div>
...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.4.1/plainmd_1.4.1_amd64.deb">{"PlainMD v1.4.1 (amd64-deb)"}</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.4.1/plainmd-1.4.1-x86_64.AppImage">{"PlainMD v1.4.1 (x86_64-AppImage)"}</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.4.1/plainmd-1.4.1-x86_64.flatpak">{"PlainMD v1.4.1 (x86_64-flatpak)"}</DownloadLinkButton>
</div>
...
<div class="flex gap-2">
  ...
  <LinkButton
    ...
    icon="codeberg"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd">{"Get it on Codeberg"}</LinkButton>
</div>
