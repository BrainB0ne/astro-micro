...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.3.1/plainmd-1.3.1-x64-setup.exe"
  >PlainMD v1.3.1 (win64-installer)</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.3.1/plainmd-1.3.1-x64.zip"
  >PlainMD v1.3.1 (win64-zip)</DownloadLinkButton>
</div>
...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.3.1/plainmd_1.3.1_amd64.deb"
  >PlainMD v1.3.1 (amd64-deb)</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://codeberg.org/BrainB0ne/plainmd/releases/download/v1.3.1/plainmd-1.3.1-x86_64.AppImage"
  >PlainMD v1.3.1 (x86_64-AppImage)</DownloadLinkButton>
</div>
