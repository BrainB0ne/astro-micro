...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://github.com/BrainB0ne/icySteps/releases/download/v0.1.0/icySteps.Setup.0.1.0.exe">{"icySteps v0.1.0 (installer)"}</DownloadLinkButton>
</div>
...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://github.com/BrainB0ne/icySteps/releases/download/v0.1.0/icysteps_0.1.0_amd64.deb">{"icySteps v0.1.0 (amd64-deb)"}</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://github.com/BrainB0ne/icySteps/releases/download/v0.1.0/icySteps-0.1.0.AppImage">{"icySteps v0.1.0 (AppImage)"}</DownloadLinkButton>
</div>
