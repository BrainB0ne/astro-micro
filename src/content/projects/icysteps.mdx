...
- **Themes** - Choose a light Azure, Lavender, Blush, or Apricot theme, or a dark Midnight, Evergreen, or Ember theme per journey. The theme applies to the editor, live preview, and exported book.
...
```
v0.2.1
This release makes deletion confirmations easier to dismiss while editing a journey.
- Click anywhere outside a photo, chapter, or journey deletion confirmation to cancel it without deleting anything.
- Press Escape to dismiss an open deletion confirmation.

v0.2.0
This release adds dark journey themes and refines the editor, photo controls, and travel book preview.
- Added Midnight, Evergreen, and Ember themes, with matching dark pages in PDF, HTML, and ZIP exports.
- Matched the HTML photo viewer, editor scrollbars, text resize handle, and live preview shadow to the selected theme.
- Expanded the journey editor to use available window width and reduced empty space below short chapter texts.
- Improved photo thumbnails to show complete images and fit more photos per row. Moved **Remove Photo** beside the caption.
- Added in-editor confirmations for photo, chapter, and journey deletion, so Cancel no longer blocks the editor.

v0.1.1
This release improves the layout of exported travel books.
- Exported cover titles, chapter titles, and chapter text now use the full available page width.
```
...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://github.com/BrainB0ne/icySteps/releases/download/v0.2.1/icySteps.Setup.0.2.1.exe">{"icySteps v0.2.1 (installer)"}</DownloadLinkButton>
</div>
...
<div class="flex flex-wrap gap-2">
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://github.com/BrainB0ne/icySteps/releases/download/v0.2.1/icysteps_0.2.1_amd64.deb">{"icySteps v0.2.1 (amd64-deb)"}</DownloadLinkButton>
  <DownloadLinkButton
    icon="download"
    loading="lazy"
    href="https://github.com/BrainB0ne/icySteps/releases/download/v0.2.1/icySteps-0.2.1.AppImage">{"icySteps v0.2.1 (AppImage)"}</DownloadLinkButton>
</div>
