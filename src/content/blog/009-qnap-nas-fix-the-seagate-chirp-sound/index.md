...
4. Download and install PuTTY on your desktop to login with a SSH connection to the QNAP NAS. PuTTY for Windows can be downloaded here: [PuTTY for Windows Installer](https://the.earth.li/~sgtatham/putty/latest/x86/putty-0.62-installer.exe)
